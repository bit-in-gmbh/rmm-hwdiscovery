...
- Expanded package and exported API documentation to clarify field meanings, units, normalization, omission semantics, deterministic ordering, and platform behavior.
